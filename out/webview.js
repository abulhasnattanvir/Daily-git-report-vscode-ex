...
exports.showReportWebview = showReportWebview;
const vscode = __importStar(require("vscode"));
function showReportWebview(report) {
    const panel = vscode.window.createWebviewPanel('dailyGitReport', 'Daily Git Report', vscode.ViewColumn.One, {
        enableScripts: true,
